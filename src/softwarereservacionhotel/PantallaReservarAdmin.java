...
public class PantallaReservarAdmin extends javax.swing.JFrame {
    ...
    FondoReservarCliente FondoReservarCliente = new PantallaReservarAdmin.FondoReservarCliente();
    private static PantallaReservarAdmin instancia;
    ...
    public static PantallaReservarAdmin getInstancia() {
        if (instancia == null) {
            instancia = new PantallaReservarAdmin();
        }
        return instancia;
    }
    ...
    private void initComponents() {
        ...
        btnAdminConUso = new javax.swing.JButton();
        ...
        btnAdminConUso.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        btnAdminConUso.setContentAreaFilled(false);
        btnAdminConUso.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnAdminConUso.setFocusPainted(false);
        btnAdminConUso.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAdminConUsoActionPerformed(evt);
            }
        });
        jPanel1.add(btnAdminConUso, new org.netbeans.lib.awtextra.AbsoluteConstraints(1100, 58, 110, 60));
    ...
    private void btnAdminConUsoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdminConUsoActionPerformed
        // TODO add your handling code here:
        PantallaBtnAdmin ph = new PantallaBtnAdmin();
        ph.setVisible(true);
        dispose(); // Cerrar la ventana actual
    }//GEN-LAST:event_btnAdminConUsoActionPerformed
    ...
    private javax.swing.JButton btnAdminConUso;
